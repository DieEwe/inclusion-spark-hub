...
import VideosPage from "./pages/template-a/videos";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/:template/:schnack" element={<TemplateRouter />} />
          <Route path="/template-a" element={<SubIndex />} />
          ...
          <Route path="/template-a/videos" element={<VideosPage />} />
